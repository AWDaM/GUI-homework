...
InheritedInteractive::InheritedInteractive(SDL_Rect& pos, iPoint posOffset, j1Module * callback, bool draggable) : Interactive(pos, posOffset, callback), UIElement(pos, draggable)
{
}
